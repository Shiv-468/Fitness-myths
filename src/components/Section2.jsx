    ...
    <div className='container section2_padding_top max_width_1140'>
        <div className='section2_box mx-auto bg_black_box position-relative'>
          <div className=" position-absolute z-0 BoxEllipse">
            ...
            <p className='mb-0 color_white text-center font_size_md line_height_xlg z-1'>That annoying little hacker is simply a lack of knowledge. Sounds ridiculous, right? Stick with me here…. If I knew back then (in my playing days) what I know now, I would probably still be playing instead of writing this eBook.</p>
