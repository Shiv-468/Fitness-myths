        ...
        <div className=" container max_width_1170 aboutSection_padding_bottom aboutSection_padding_top">
            <div className="row">
                ...
                <div className=" col-12 col-lg-6 d-flex align-items-lg-end justify-content-center justify-content-lg-end mt-5 mt-lg-0">
                    ...
                    <p className=' mb-0 color_white font_size_md line_height_xlg margin_top_13 font_family_Manrope'>Francesco is a Pro fitness coach currently working as head of Sport Science for Toronto FC Academy. He is a registered nutritionist, certified strength and conditioning specialist, holds a Master’s in exercise science and is a national level soccer coach.</p>
                    <p className=' mb-0 color_white font_size_md line_height_xlg margin_top_10 font_family_Manrope'>He has been a personal performance coach to a 1000+ elite level footballers ranging from youth internationals all the way to top level pro’s</p>
                    <p className=' mb-0 color_white font_size_md line_height_xlg margin_top_10 font_family_Manrope'>Francesco believes every footballer should have access to a rock-solid S&C program alongside a quality nutrition plan to improve the chances of crushing their genetic athletic potential and becoming the best version of themselves.</p>
